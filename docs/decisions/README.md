...
| -------- | ---------------------------------------------------------------------------------------------------- | -------- | ---------- | ---------------------------- |
| ADR-0000 | [Decision Record Template](ADR-0000-template.md)                                                     | accepted | 2025-08-22 | meta, process                |
| ADR-0001 | [Target Linux and Windows Desktops via GitHub Releases](ADR-0001-desktop-platforms.md)               | accepted | 2025-08-22 | platform, distribution       |
